...
interface CreateStartDatePopupProps {
  isOpen: boolean;
  onClose: () => void;
  onCreate: () => void;
  startDate: string;
        ...
        <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
          ...
          <div>
            ...
            <input
              ...
              className="border-secondary-blue/40 focus:border-tertiary-blue/60 focus:ring-tertiary-blue/40 w-full rounded-xl border bg-white/10 px-4 py-3 text-sm font-medium text-white shadow-sm backdrop-blur-md transition-all duration-300 focus:ring-2 focus:outline-none sm:rounded-2xl sm:px-6 sm:py-4 sm:text-base"
              autoFocus
            />
          </div>
...
export default CreateStartDatePopup;
